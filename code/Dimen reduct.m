...
%akpca
% [L,V,Train]=akpca(X',10,100,59,1);
% yuanshu=Train';
% %PCA
%[yuanshu, mapping] = compute_mapping(X, 'PCA',10);
%Laplacian
% [yuanshu, mapping] = compute_mapping(X, 'Laplacian',100);
%LFDA
[T,Z]=LFDA(X',label,10);
yuanshuSHU=T'*X';
yuanshu=yuanshuSHU';
