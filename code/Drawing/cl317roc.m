...
save 317LFDA.mat x4 y4
%plotroc(tar_label',dec')
% [Sn ,Sp,MCC] =JG(label,predict_label )
% % % zhunquelv=svmpredict(label,shu,'- v 653')
% % % save 66db9.zui.mat ACC Sn Sp MCC 
% % tp=[0 0 0 0 0 0 0 0];
% % tn=[0 0 0 0 0 0 0 0];
% % fn=[0 0 0 0 0 0 0 0];
% % fp=[0 0 0 0 0 0 0 0];
...
% % end
% % end
% plotSVMroc(label,predict_label,8)